...
The **Museum With No Frontiers — Paintings** gallery, built from the published
dataset `@museumwnf/paintings-data`.
...
| Package | Role |
| --- | --- |
| `@museumwnf/paintings-data` | the dataset (JSON + `manifest.json`) |
...
<https://museumwithnofrontiers.github.io/paintings/> through the reusable workflows in
