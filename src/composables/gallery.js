...
// `useGalleryData.js` used to be byte-identical local copies of what paintings
...
// legacy project key, no UUID — paintings shares the same entity list and
...
export const itemSheet = {
  ...
  related: {
    ...
    // Since inventory-app#1807 (paintings-data 1.0.11+), an outside
