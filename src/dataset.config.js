...
export default {
  ...
  home: {
    title: 'paintings.identity.title',
    intro: 'paintings.home.intro',
    cards: [
      {
        title: 'paintings.nav.catalogue',
        description: 'paintings.home.catalogueText',
    ...
    featured: {
      entity: 'items',
      heading: 'paintings.home.itemOnDisplay',
  ...
  navigation: {
    ...
    links: [
      ...
      { section: 'catalogue', label: 'paintings.nav.catalogue', to: { name: 'catalogue' } },
      { section: 'about', label: 'paintings.nav.about', to: { name: 'about' } },
    ],
  },
  ...
  //
  //   extraViews: [
  //     ...standardRoutes('gallery', { creditsBody: 'paintings.credits.body' }),
  ...
  //       partnerObjects: {
  //         emptyPartner: 'paintings.partnerObjects.emptyPartner',
  //         emptyInstitution: 'paintings.partnerObjects.emptyInstitution',
  //         institutionSummary: 'paintings.partner.monumentsInExhibition',
  //         partnerProfileLabel: 'paintings.partnerObjects.partnerProfile',
  //         institutionProfileLabel: 'paintings.partnerObjects.institutionProfile',
  //       },
  //     }),
  //     // + this website's own routes: home, item, collection entrance,
  //     // timeline entrance, partners entrance
