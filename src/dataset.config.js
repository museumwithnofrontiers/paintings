...
export default {
  ...
  // one entry for every project id `npm pack @museumwnf/paintings-data`
  // carries in `manifest.projects` (checked 2026-09-19, paintings-data 1.0.9).
  ...
  projectColors: {
    '08eff25c-24af-5d7d-8635-18ea15aca879': 'mwnf-chip--EXH', // The Use Of Colours In Art (auto-mapped, unknown project id — verify)
  ...
  site: { origin: 'https://museumwithnofrontiers.github.io/paintings' },
